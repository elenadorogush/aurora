 ...
 * @version $Id: PositionNode.java 38 2010-02-08 22:59:00Z akurzhan $
 */
public class PositionNode implements AuroraConfigurable, Serializable {
	...
	public void xmlDump(PrintStream out) throws IOException {
		if (out == null)
			out = System.out;
		out.print("<position>");
		out.print("<point lat=\"" + Double.toString(p.y) + "\" long=\"" + Double.toString(p.x) + "\" elevation=\"" + Double.toString(p.z) + "\"/>");
		out.print("</position>");
		return;
	}
